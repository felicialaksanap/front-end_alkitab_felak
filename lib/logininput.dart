    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text("Selamat Datang !", style: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 30, color: Color.fromARGB(255, 85, 48, 29)))),
            Text("Masuk ke akun anda !", style: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 18, color: Color.fromARGB(255, 95, 95, 95)))),
            ...
            Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Text(
                  "Lupa kata sandi?", 
                  style: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 14, color: Color.fromARGB(255, 95, 95, 95), decoration: TextDecoration.underline)),
                  ),
                ),
              ],
            ),
